...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="Abogados Asociados Especialistas en el Huila">
    ...
    <div class="column one">
        <div class="image_frame scale-with-grid">
            <div class="image_wrapper">
                ...
                <h2 style="text-align:center">Colpensiones o fondo privado ¿Cuál es mejor?</h2>
                <div class=""></div><img  style=" display: block; margin-left: auto;  margin-right: auto; width: 50%;" width="800" height="380" src="images/ahorros_para_la_vejez.jpg" class="scale-with-grid wp-post-image" alt="beauty_portfolio_2" />
                </div>
        </div>
    </div>
...
Para todos los trabajadores en Colombia es un anhelo permitirse gozar de una pensión al final de su vida laboral, después de tanto esfuerzo, durante toda la vida, que mejor que tener una seguridad económica que le permita vivir con tranquilidad los últimos años de su vida. Pero, realmente sabes si los ahorros que has hecho para la vejez te darán los rendimientos esperados. A continuación te vamos a contar todo lo que debes saber sobre los fondos de pensiones. 
            ...
            <div class="column one column_column">
                <div class="column_attr ">
                <h3 style="margin: 0 40px 15px;">¿Qué son los fondos de pensión?</h3>
                    <p class="flv_style_4" style="text-align: justify; margin: 0 40px 15px;">
            ...
            <div class="column one column_column">
                <div class="column_attr ">
                <h3 style="margin: 0 40px 15px;">¿Qué tipos de fondos de pensiones existen en Colombia? </h3>
                    <p class="flv_style_4" style="text-align: justify;margin: 0 40px 15px;">
                    En Colombia existen dos tipos de fondos de pensiones; el <u><strong>público o estatal llamado Colpensiones</strong></u> y los <u><strong>fondos de pensiones privados</strong></u>, algunos de ellos son, Porvenir, Protección, Colfondos entre otros, aquí te vamos a contar de que se trata cada uno de estos regímenes de pensión.                     </p>
                </div>
            </div>
            <!-- One full width row-->
                <!-- One full width row-->
                <div class="column one column_column">
                <div class="column_attr ">
                <h3 style="margin: 0 40px 15px;">Colpensiones fondo de financiamiento público</h3>
                    <p class="flv_style_4" style="text-align: justify;margin: 0 40px 15px;">
                    ...
                    <h4 style="margin: 0 40px 15px;">Ventajas</h4>
                    <ul style="margin: 0 40px 15px;margin-left: 120px;" >
                        <li>
                    ...
                    <h4 style="margin: 0 40px 15px;">Desventajas</h4>
                    <ul style="margin: 0 40px 15px;margin-left: 120px;" >
                        <li>
            ...
            <!-- One full width row-->
                            ...
                            <div class="column one column_column">
                <div class="column_attr ">
                <h3 style="margin: 0 40px 15px;">Fondos privados  </h3>
                    <p class="flv_style_4" style="text-align: justify;margin: 0 40px 15px;">
            ...
            <div class="column one column_column">
                <div class="column_attr ">
                <h3 style="margin: 0 40px 15px;">¿Cuál fondo de pensiones me conviene más?</h3>
                </br>
                <p class="flv_style_4" style="text-align: justify;margin: 0 40px 15px;">
            ...
            <div class="column one column_column">
                <div class="column_attr ">
                <h3 style="margin: 0 40px 15px;">¿Puedo cambiarme de fondo de pensiones de privado a público o viceversa?</h3>
                </br>
                <p class="flv_style_4" style="text-align: justify;margin: 0 40px 15px;">
            ...
            <div class="column one column_column">
                <div class="column_attr ">
                <h3 style="margin: 0 40px 15px;">En resumen</h3>
                    <p class="flv_style_4" style="text-align: justify;margin: 0 40px 15px;">
        ...
        <div class="faq">
            ...
            <div class="mfn-acc faq_wrapper ">
                <div style="margin: 0 40px 15px;"class="question">
                    <div class="title">
                        <span class="num">1</span><i class="icon-plus acc-icon-plus"></i><i class="icon-minus acc-icon-minus"></i>¿Si cambio de régimen privado al público o del público al privado mis ahorros se verán afectados?
                    </div>
                    <div class="answer">
                ...
                <div style="margin: 0 40px 15px;" class="question">
                    <div class="title">
                        <span class="num">2</span><i class="icon-plus acc-icon-plus"></i><i class="icon-minus acc-icon-minus"></i>¿Puedo pensionarme si he cumplido las semanas cotizadas pero no la edad?
                    </div>
                    <div class="answer">
                ...
                <div style="margin: 0 40px 15px;" class="question">
                    <div class="title">
                        <span class="num">3</span><i class="icon-plus acc-icon-plus"></i><i class="icon-minus acc-icon-minus"></i>¿Si ya pasé de la edad establecida para hacer el cambio de régimen pensional que puedo hacer si deseo hacerlo?
                    </div>
                    <div class="answer">
...
<div class="items_group clearfix">
    ...
    <div class="column one-third column_our_team">
        ...
        <div class="team team_circle">
            <div class="image_frame no_link scale-with-grid">
                <div class="image_wrapper"><img class="scale-with-grid" src="images/LUIS EDUARDO GUTIERREZ ROJAS.png" alt="Abogados Neiva" width="200px" height="200px" />
                </div>
            </div>
            <div class="desc_wrapper">
                <h4>Luis Eduardo Gutierrez</h4>
                <p class="subtitle">
